...
public class PrevisualiserConsultationClientAction extends Action {
    ...
    public void execute(HttpServletRequest request) {
        System.out.println("[TEST] Execution de PrevisualiserConsultationClientAction : début");
        ...
        if (client != null) {      
            ...
            System.out.println("\u001b[32m" + "[TEST] Execution de PrevisualiserConsultationClientAction : réussie");
        } else {
            request.setAttribute("consultations", null);
            System.out.println("\u001b[31m" + "[TEST] Execution de PrevisualiserConsultationClientAction : null");
        }
        System.out.println("[TEST] Execution de PrevisualiserConsultationClientAction : fin");
    }
