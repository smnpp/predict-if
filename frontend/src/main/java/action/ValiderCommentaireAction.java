...
public class ValiderCommentaireAction extends Action {
    ...
    public void execute(HttpServletRequest request) {
        System.out.println("[TEST] Execution de ValiderCommentaireAction : début");
        ...
        if (success) {
            ...
            System.out.println("\u001b[32m" + "[TEST] Execution de ValiderCommentaireAction : réussie");
        }
        else {
            request.setAttribute("success", false);
            System.out.println("\u001b[31m" + "[TEST] Execution de ValiderCommentaireAction : échouée");
        }
        System.out.println("[TEST] Execution de ValiderCommentaireAction : fin");
    }
}
