...
public class VerifierConnexionAction extends Action {
    ...
    public void execute(HttpServletRequest request) {
        System.out.println("[TEST] Execution de VerifierConnexionAction : début");
        ...
        if (idClient != null || idEmploye != null) {
            ...
            System.out.println("\u001b[32m" + "[TEST] Execution de VerifierConnexionAction : connecté");
        } else {
            System.out.println("[TEST] Aucune connexion");
            request.setAttribute("idClient", null);
            request.setAttribute("idEmploye", null);
            request.setAttribute("connected", false);
            System.out.println("\u001b[31m" + "[TEST] Execution de VerifierConnexionAction : non connecté");
        }
        System.out.println("[TEST] Execution de VerifierConnexionAction : fin");
    }
}
