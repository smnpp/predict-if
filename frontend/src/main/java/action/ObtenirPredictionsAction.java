...
public class ObtenirPredictionsAction extends Action {
    ...
    public void execute(HttpServletRequest request) {
        System.out.println("[TEST] Execution de ObtenirPredictionsAction : début");
        ...
        if (predictions != null){
            ...
            System.out.println("\u001b[32m" + "[TEST] Execution de ObtenirPredictionsAction  : réussie");
        }
        else{
            request.setAttribute("liste", null);
            System.out.println("\u001b[31m" + "[TEST] Execution de ObtenirPredictionsAction : null");
        }
        System.out.println("[TEST] Execution de ObtenirPredictionsAction : fin");
    }
}
