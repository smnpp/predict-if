...
public class ProfilClientSerialisation extends Serialisation {
    ...
    public void appliquer(HttpServletRequest req, HttpServletResponse res) throws IOException {
        System.out.println("[TEST] Execution de ProfilClientSerialisation : début");
        ...
        if (client != null) {
            ...
            if (astral != null) {
                ...
                System.out.println("\u001b[32m" + "[TEST] Execution de ProfilClientSerialisation : réussie");
            }
        } else {
            clientJson.addProperty("idClient", false);
            System.out.println("\u001b[31m" + "[TEST] Execution de ProfilClientSerialisation : false");
        }
        ...
        out.close();
        System.out.println("[TEST] Execution de ProfilClientSerialisation : fin");
    }
}
